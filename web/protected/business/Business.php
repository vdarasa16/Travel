...
class Business
{
	...
	{
		return $this->parent->getModel($modelName);
	}
	
	protected function getBusiness($businessName)
	{
		return $this->parent->getBusiness($businessName);
	}
	
	protected function getSearchHelper($searchHelperName, $criteria)
	{
		return $this->parent->getSearchHelper($searchHelperName, $this->parent, $criteria);
	}
